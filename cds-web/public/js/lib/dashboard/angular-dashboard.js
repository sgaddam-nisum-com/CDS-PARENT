...
angular.module('ui.dashboard')
  .factory('WidgetModel', ["$log", function ($log) {
    ...
    function WidgetModel(widgetDefinition, overrides) {
      ...
      angular.extend(this, defaults(), _.extend(angular.copy(widgetDefinition), overrides));
